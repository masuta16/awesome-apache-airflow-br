...
- [Inferno dos dados: 7 circulos de infeno de teste de dados com Airflow](https://medium.com/wbaa/datas-inferno-7-circles-of-data-testing-hell-with-airflow-cef4adff58d8) -A equipe  Wholesale Banking Advanced Analytics em ING detalha como eles torturam testes das DAGs do Airflow antes do deployment.
-  [Teste de dados com repositorio do Airflow](https://github.com/danielvdende/data-testing-with-airflow)
- [Checadores de qualidade de dados](https://drivy.engineering/data-quality/) - [Antoine Augusti](https://twitter.com/AntoineAugusti) descreve como o framework [drivy](https://www.drivy.co.uk/) tem sido aplicado sobre o Airflow para testar o dataset deles para completude, pontualidade, distinção, validades e acuracia
- [Construindo o data warehouse da WePay usando BigQuery e Airflow](https://wecode.wepay.com/posts/wepays-data-warehouse-bigquery-airflow) - O inestimavel [Chris Riccomini](https://twitter.com/criccomini) descreve como [WePay](https://go.wepay.com/), um dos primeiros adeptos do Airflow integrou para o ambiente deles o [Google Cloud Compute](https://cloud.google.com/compute/).
...
- [ETL with airflow](https://gtoonstra.github.io/etl-with-airflow/) - Os principios do core de ETL e muitos exemplos docker end to end incluindo Kimball, data vault no Hive e alguns exemplos mais simples.
